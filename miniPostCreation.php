...
<div class="container p-5 my-5 bg-light">
    ...
    <div class="row p-3">
        <form action="" method="POST">
            <label for="miniPostTitle" class="form-label">Titre de mon mini-post*</label>
            <input type="text" class="form-control" id="miniPostTitle" name="miniPostTitle">
            ...
            <button type="submit" class="btn btn-success m-2">Publier</button>
        </form>
    </div>
